...
****************************************************************************/
function class_qvquivertypes(settings,missing){
    ...
    var oper_print=$(prefix+"oper_print").rylabel({
        ...
        button:true,
        click:function(o){
            qv_printselected(formid, objgridsel, "@customize/corsaro/reporting/rep_quivertypes.php")
        }
    });
    ...
    var oper_delete=$(prefix+"oper_delete").rylabel({
        ...
        button:true,
        click:function(o){
            qv_bulkdelete(formid, objgridsel, "quivertypes");
        }
    });
    ...
    $(prefix+"LB_OBJECTTYPEID").rylabel({left:20, top:offsety, caption:"Tipo oggetto"});
    $(prefix+"OBJECTTYPEID").rylist({left:120, top:offsety, width:300, datum:"C", tag:"OBJECTTYPEID"});offsety+=30;
    
    $(prefix+"LB_MOTIVETYPEID").rylabel({left:20, top:offsety, caption:"Tipo motivo"});
    $(prefix+"MOTIVETYPEID").rylist({left:120, top:offsety, width:300, datum:"C", tag:"MOTIVETYPEID"});offsety+=30;
    
    $(prefix+"LB_ARROWTYPEID").rylabel({left:20, top:offsety, caption:"Tipo freccia"});
    $(prefix+"ARROWTYPEID").rylist({left:120, top:offsety, width:300, datum:"C", tag:"ARROWTYPEID"});offsety+=30;
    ...
    var objgriddetails=$(prefix+"griddetails").ryque({
        ...
        solveid:function(o, d){
            currdetailid=d;
            RYQUE.query({
                sql:"SELECT * FROM QVQUIVERVIEWS WHERE SYSID='"+d+"'",
                ready:function(v){
                    try{
    ...
    var oper_detailsdelete=$(prefix+"oper_detailsdelete").rylabel({
        ...
        button:true,
        click:function(o){
            qv_bulkdelete(formid, objgriddetails, "quiverviews");
        }
    });

    // DEFINIZIONE TAB DOCUMENTI
    var filemanager=new qv_filemanager(this, formid, "QVQUIVERTYPES");
        ...
        select:function(i,p){
            ...
            if(!flagsuspend){
                ...
                case 2:
                    ...
                    RYQUE.query({
                        sql:"SELECT * FROM QVQUIVERTYPES WHERE SYSID='"+currsysid+"'",
                        ready:function(v){
                ...
                case 3:
                    ...
                    objgriddetails.query({
                        ready:function(){
                            qv_contextmanagement(context, {sysid:currsysid, table:"QVQUIVERTYPES", select:"DESCRIPTION", formula:"[=DESCRIPTION]",
                                done:function(d){
                                    context=d;
                                    lb_details_context.caption("Contesto: "+context);
                                }
        ...
        function(){
            ...
            objgridsel.query({
                ready:function(){
                    ...
                    TAIL.enqueue(qv_queuelistcall, {"id": formid+"ARROWTYPEID", "table":"#QVARROWTYPES"});
