...
****************************************************************************/
function class_qvmotivetypes(settings,missing){
    ...
    var oper_delete=$(prefix+"oper_delete").rylabel({
        ...
        button:true,
        click:function(o){
            qv_bulkdelete(formid, objgridsel, "motivetypes");
        }
    });
    ...
    var objgriddetails=$(prefix+"griddetails").ryque({
        ...
        solveid:function(o, d){
            currdetailid=d;
            RYQUE.query({
                sql:"SELECT * FROM QVMOTIVEVIEWS WHERE SYSID='"+d+"'",
                ready:function(v){
                    try{
    ...
    var oper_detailsdelete=$(prefix+"oper_detailsdelete").rylabel({
        ...
        button:true,
        click:function(o){
            qv_bulkdelete(formid, objgriddetails, "motiveviews");
        }
    });

    // DEFINIZIONE TAB DOCUMENTI
    var filemanager=new qv_filemanager(this, formid, "QVMOTIVETYPES");
        ...
        select:function(i,p){
            ...
            if(!flagsuspend){
                ...
                case 2:
                    ...
                    RYQUE.query({
                        sql:"SELECT * FROM QVMOTIVETYPES WHERE SYSID='"+currsysid+"'",
                        ready:function(v){
                ...
                case 3:
                    ...
                    objgriddetails.query({
                        ready:function(){
                            qv_contextmanagement(context, {sysid:currsysid, table:"QVMOTIVETYPES", select:"DESCRIPTION", formula:"[=DESCRIPTION]",
                                done:function(d){
                                    context=d;
                                    lb_details_context.caption("Contesto: "+context);
                                }
