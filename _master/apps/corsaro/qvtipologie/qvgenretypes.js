...
****************************************************************************/
function class_qvgenretypes(settings,missing){
    ...
    var oper_print=$(prefix+"oper_print").rylabel({
        ...
        button:true,
        click:function(o){
            qv_printselected(formid, objgridsel, "@customize/corsaro/reporting/rep_genretypes.php")
        }
    });
    ...
    var oper_delete=$(prefix+"oper_delete").rylabel({
        ...
        button:true,
        click:function(o){
            qv_bulkdelete(formid, objgridsel, "genretypes");
        }
    });
    ...
    var objgriddetails=$(prefix+"griddetails").ryque({
        ...
        solveid:function(o, d){
            currdetailid=d;
            RYQUE.query({
                sql:"SELECT * FROM QVGENREVIEWS WHERE SYSID='"+d+"'",
                ready:function(v){
                    try{
    ...
    $(prefix+"oper_detailsnew").rylabel({
        ...
        click:function(o){
            ...
            data["CAPTION"]="Etichetta";
            RYWINZ.Post(_systeminfo.relative.cambusa+"ryquiver/quiver.php", 
                {
                    "sessionid":_sessioninfo.sessionid,
                    "env":_sessioninfo.environ,
                    "function":"genreviews_insert",
                    "data":data
                }, 
                function(d){
                    try{
    ...
    var oper_detailsdelete=$(prefix+"oper_detailsdelete").rylabel({
        ...
        button:true,
        click:function(o){
            qv_bulkdelete(formid, objgriddetails, "genreviews");
        }
    });

    // DEFINIZIONE TAB DOCUMENTI
    var filemanager=new qv_filemanager(this, formid, "QVGENRETYPES");
        ...
        select:function(i,p){
            ...
            if(!flagsuspend){
                ...
                case 2:
                    ...
                    RYQUE.query({
                        sql:"SELECT * FROM QVGENRETYPES WHERE SYSID='"+currsysid+"'",
                        ready:function(v){
                ...
                case 3:
                    ...
                    objgriddetails.query({
                        ready:function(){
                            qv_contextmanagement(context, {sysid:currsysid, table:"QVGENRETYPES", select:"DESCRIPTION", formula:"[=DESCRIPTION]",
                                done:function(d){
                                    context=d;
                                    lb_details_context.caption("Contesto: "+context);
                                }
