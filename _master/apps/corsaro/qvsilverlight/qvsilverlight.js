...
function class_qvsilverlight(settings,missing){
    ...
    if($.isset(settings["source"])){
        ...
        sl_source=_cambusaURL+"rygeneral/sl_wrapper.php?source="+sl_source+"&formid="+formid+"&sessionid="+_sessioninfo.sessionid+"&env="+_sessioninfo.environ+"&userid="+_sessioninfo.userid+"&root="+_systeminfo.web.root;
