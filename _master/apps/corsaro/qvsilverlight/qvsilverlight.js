...
function class_qvsilverlight(settings,missing){
    ...
    if($.isset(settings["source"])){
        ...
        sl_source=sl_source.replace(/@cambusa\//gi, _systeminfo.web.cambusa);
        sl_source=sl_source.replace(/@apps\//gi, _systeminfo.web.apps);
        sl_source=sl_source.replace(/@customize\//gi, _systeminfo.web.customize);
        sl_source=_systeminfo.web.cambusa+"rygeneral/sl_wrapper.php?source="+sl_source+"&formid="+formid+"&sessionid="+_sessioninfo.sessionid+"&env="+_sessioninfo.environ+"&userid="+_sessioninfo.userid+"&root="+_systeminfo.web.root;
