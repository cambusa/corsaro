...
function class_qvquivers(settings,missing){
    ...
    var oper_print=$(prefix+"oper_print").rylabel({
        ...
        button:true,
        click:function(o){
            qv_printselected(formid, objgridsel, "@customize/corsaro/reporting/rep_quivers.php")
        }
    });
    ...
    $(prefix+"lbfx_amount").rylabel({left:offsetx+155, top:offsety, caption:"Quantità"+" &plusmn;5%"});
    offsety+=20;
