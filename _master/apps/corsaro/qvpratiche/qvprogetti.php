...
<div relid="tabs" >
    ...
    <div>
        ...
        <div relid="oper_prjadd"></div><div relid="oper_prjremove"></div><div relid="oper_prjempty"></div>
        <div relid="gridpratiche"></div>
        <div relid="contestobottom">&nbsp;</div>
    </div>
    <div>
        <div relid="gantt_context"></div>
        <div relid="oper_ganttrefresh"></div>
        <div relid="lb_gantt_zoom"></div><div relid="gantt_zoom"></div>
