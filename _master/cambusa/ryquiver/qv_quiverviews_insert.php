<?php 
/****************************************************************************
* Name:            qv_quiverviews_insert.php                                *
...
function qv_quiverviews_insert($maestro, $data){
    ...
    try{
        ...
        qv_solverecord($maestro, $data, "QVQUIVERTYPES", "TYPOLOGYID", "TYPOLOGYNAME", $TYPOLOGYID);
        if($TYPOLOGYID==""){
            $babelcode="QVERR_QUIVERTYPE";
            $b_params=array();
            $b_pattern="Tipo di faretra non specificato";
            throw new Exception( qv_babeltranslate($b_pattern, $b_params) );
        }
        ...
        if(isset($data["FIELDNAME"])){
            ...
            qv_checkfieldname($maestro, "QVQUIVERVIEWS", $SYSID, $TYPOLOGYID, $FIELDNAME);
        }
        else{
        ...
        qv_deleteview($maestro, "QVQUIVER", $TYPOLOGYID);
        ...
        $sql="INSERT INTO QVQUIVERVIEWS($columns) VALUES($values)";
        ...
        // RICREO LA VIEW
        qv_refreshview($maestro, "QVQUIVER", $SYSID, $TYPOLOGYID);
    }
    catch(Exception $e){
        $success=0;
