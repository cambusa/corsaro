...
function qv_genretypes_insert($maestro, $data){
    ...
    try{
        ...
        $columns="SYSID,NAME,DESCRIPTION,VIEWNAME,TABLENAME,DELETABLE,SIMPLE,VIRTUALDELETE,HISTORICIZING,TAG";
        $values="'$SYSID','$NAME','$DESCRIPTION','$VIEWNAME','$TABLENAME',$DELETABLE,$SIMPLE,$VIRTUALDELETE,$HISTORICIZING,'$TAG'";
        $sql="INSERT INTO QVGENRETYPES($columns) VALUES($values)";
