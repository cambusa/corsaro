...
function qv_genretypes_delete($maestro, $data){
    ...
    try{
        ...
        if($SYSID!=""){
            qv_deletable($maestro, "QVGENRES", "TYPOLOGYID", $SYSID);
            qv_deletable($maestro, "QVGENREVIEWS", "TYPOLOGYID", $SYSID);
            qv_deletable($maestro, "QVOBJECTTYPES", "GENRETYPEID", $SYSID);
            qv_deletable($maestro, "QVARROWTYPES", "GENRETYPEID", $SYSID);
            qv_deletable($maestro, "QVQUIVERTYPES", "GENRETYPEID", $SYSID);
            
            // DROPPO LA VECCHIA VIEW
            qv_deleteview($maestro, "QVGENRE", $SYSID);

            $sql="DELETE FROM QVGENRETYPES WHERE SYSID='$SYSID'";
