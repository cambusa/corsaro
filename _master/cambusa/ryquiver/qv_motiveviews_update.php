<?php 
/****************************************************************************
* Name:            qv_motiveviews_update.php                                *
...
function qv_motiveviews_update($maestro, $data){
    ...
    try{
        ...
        $sets="";
        $record=qv_solverecord($maestro, $data, "QVMOTIVEVIEWS", "SYSID", "", $SYSID, "TYPOLOGYID");
        if($SYSID==""){
        ...
        if($sets!=""){
            $sql="UPDATE QVMOTIVEVIEWS SET $sets WHERE SYSID='$SYSID'";
