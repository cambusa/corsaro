<?php 
/****************************************************************************
* Name:            qv_objectviews_update.php                                *
...
function qv_objectviews_update($maestro, $data){
    ...
    try{
        ...
        $sets="";
        $record=qv_solverecord($maestro, $data, "QVOBJECTVIEWS", "SYSID", "", $SYSID, "TYPOLOGYID");
        if($SYSID==""){
        ...
        if($sets!=""){
            $sql="UPDATE QVOBJECTVIEWS SET $sets WHERE SYSID='$SYSID'";
