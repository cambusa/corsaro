...
function qv_arrowviews_insert($maestro, $data){
    ...
    try{
        ...
        qv_solverecord($maestro, $data, "QVARROWTYPES", "TYPOLOGYID", "TYPOLOGYNAME", $TYPOLOGYID);
        if($TYPOLOGYID==""){
            $babelcode="QVERR_ARROWTYPE";
            $b_params=array();
        ...
        if(isset($data["FIELDNAME"])){
            ...
            qv_checkfieldname($maestro, "QVARROWVIEWS", $SYSID, $TYPOLOGYID, $FIELDNAME);
        }
        else{
        ...
        $sql="INSERT INTO QVARROWVIEWS($columns) VALUES($values)";
