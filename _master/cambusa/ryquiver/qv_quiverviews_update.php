<?php 
/****************************************************************************
* Name:            qv_quiverviews_update.php                                *
...
function qv_quiverviews_update($maestro, $data){
    ...
    try{
        ...
        $sets="";
        $record=qv_solverecord($maestro, $data, "QVQUIVERVIEWS", "SYSID", "", $SYSID, "TYPOLOGYID");
        if($SYSID==""){
        ...
        if($sets!=""){
            $sql="UPDATE QVQUIVERVIEWS SET $sets WHERE SYSID='$SYSID'";
