<?php 
/****************************************************************************
* Name:            qv_motivetypes_insert.php                                *
...
function qv_motivetypes_insert($maestro, $data){
    ...
    try{
        ...
        $columns="SYSID,NAME,DESCRIPTION,VIEWNAME,OBJECTTYPEID,TABLENAME,DELETABLE,SIMPLE,VIRTUALDELETE,HISTORICIZING,TAG";
        $values="'$SYSID','$NAME','$DESCRIPTION','$OBJECTTYPEID','$VIEWNAME','$TABLENAME',$DELETABLE,$SIMPLE,$VIRTUALDELETE,$HISTORICIZING,'$TAG'";
        $sql="INSERT INTO QVMOTIVETYPES($columns) VALUES($values)";
