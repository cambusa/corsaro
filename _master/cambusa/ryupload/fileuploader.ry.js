...
// Rudyz
qq.setHtml = function(element, text){
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _addToList: function(id, fileName){
        ...
        // Rudyz
        qq.setHtml(fileElement, "<a id='anchor_"+id+"' class='anchor_uploading' target='_blank'>"+this._formatFileName(fileName)+"</a>");
    ...
    _onComplete: function(id, xhr){
        ...
        if (xhr.status == 200){
            ...
            try {
                ...
                // Rudyz
                document.getElementById("anchor_"+id).className="anchor_uploaded";
                document.getElementById("anchor_"+id).href=response.url;
            } catch(err){
                response = {};
            }
