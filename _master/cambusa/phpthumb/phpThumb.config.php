...
$PHPTHUMB_CONFIG['allow_src_above_docroot']     = true;   // if false (default) only allow src within document_root; if true, allow src to be anywhere in filesystem
...
$PHPTHUMB_CONFIG['cache_directory'] =  __DIR__ .'/cache/';                            // set the cache directory relative to the phpThumb() installation
